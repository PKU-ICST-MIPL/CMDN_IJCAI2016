...
## TEXT LAYER - 1.
  ...
  python ${trainer} ${mdbn_dir}/models/text_rbm1.pbtxt \
    ${mdbn_dir}/trainers/dbn/train_CD_text_layer1.pbtxt ${mdbn_dir}/eval.pbtxt || exit 1
  python ${extract_rep} ${model_output_dir}/text_rbm1_LAST \
    ${mdbn_dir}/trainers/dbn/train_CD_text_layer1.pbtxt text_hidden1 \
...
## TEXT LAYER - 2.
  ...
  python ${trainer} ${mdbn_dir}/models/text_rbm2.pbtxt \
    ${mdbn_dir}/trainers/dbn/train_CD_text_layer2.pbtxt ${mdbn_dir}/eval.pbtxt || exit 1
  python ${extract_rep} ${model_output_dir}/text_rbm2_LAST \
    ${mdbn_dir}/trainers/dbn/train_CD_text_layer2.pbtxt text_hidden2 \
