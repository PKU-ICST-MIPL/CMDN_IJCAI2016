...
prefix=${deepnet}/examples/CMDN/multimodal_dbn/data
...
#(
  ...
  python ${trainer} ${mdbn_dir}/models/image_rbm1.pbtxt \
    ${mdbn_dir}/trainers/dbn/train_CD_image_layer1.pbtxt ${mdbn_dir}/eval.pbtxt || exit 1
  python ${extract_rep} ${model_output_dir}/image_rbm1_LAST \
    ${mdbn_dir}/trainers/dbn/train_CD_image_layer1.pbtxt image_hidden1 \
...
## IMAGE LAYER - 2.
  ...
  python ${trainer} ${mdbn_dir}/models/image_rbm2.pbtxt \
    ${mdbn_dir}/trainers/dbn/train_CD_image_layer2.pbtxt ${mdbn_dir}/eval.pbtxt || exit 1
  python ${extract_rep} ${model_output_dir}/image_rbm2_LAST \
    ${mdbn_dir}/trainers/dbn/train_CD_image_layer2.pbtxt image_hidden2 \
