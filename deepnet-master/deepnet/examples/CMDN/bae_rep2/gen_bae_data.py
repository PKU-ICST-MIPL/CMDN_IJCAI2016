...
def main():
  prefix = '.'
  image_path = os.path.join(prefix, 'bae_rep/data/ae_reps/bae_LAST/train/image_tied_hidden-00001-of-00001.npy')
  text_path = os.path.join(prefix, 'bae_rep/data/ae_reps/bae_LAST/train/text_tied_hidden-00001-of-00001.npy')
  ...
  save_dir = os.path.join('bae_rep2/data')
  ...
  for dataset in ['validation', 'test']:
    s = os.path.join(prefix, 'bae_rep/data/ae_reps/bae_LAST', dataset, 'image_tied_hidden-00001-of-00001.npy')
    d = os.path.join(save_dir, dataset + image_name)
    os.system('cp ' + s + ' ' + d)
    s = os.path.join(prefix, 'bae_rep/data/ae_reps/bae_LAST', dataset, 'text_tied_hidden-00001-of-00001.npy')
    d = os.path.join(save_dir, dataset + text_name)
    os.system('cp ' + s + ' ' + d)

  os.system('cp bae_lab/data/train_lab_data.npy bae_rep2/data/')
  os.system('cp bae_lab/data/test_lab_data.npy bae_rep2/data/')
  os.system('cp bae_lab/data/validation_lab_data.npy bae_rep2/data/')
  os.system('cp bae_lab/data/bae_train_lab_data.npy bae_rep2/data/')
